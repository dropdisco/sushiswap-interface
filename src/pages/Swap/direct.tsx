...
import { ArrowWrapper, BottomGrouping, SwapCallbackError, WrapperNoPadding } from '../../components/swap/styleds'
...
export default function Swap({ tokenA, tokenB }: SwapProps) {
    ...
    <>
      ...
      <PluginBody>
        <WrapperNoPadding id="swap-page">
          ...
          <AutoColumn gap={isExpertMode ? 'md' : 'none'}>
            <CurrencyInputPanel
            ...
            {!isExpertMode && (
              <div style={{ position: 'relative', zIndex: 2 }}>
                ...
                >
                  <svg
                    style={{ height: '1.4rem', width: '1.4rem', margin: '0 auto' }}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
