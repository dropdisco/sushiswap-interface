...
import { Dots, WrapperNoPadding } from '../Pool/styleds'
...
export default function AddLiquidity({ currencyIdA, currencyIdB }: AddLiquidityProps) {
  ...
  const isCreate = false //history.location.pathname.includes('/create')
    ...
    <>
      <PluginBody>
        <WrapperNoPadding>
          ...
          />
          <AutoColumn gap={isCreate ? 'md' : 'none'}>
            {noLiquidity ||
              (isCreate && (
                <ColumnCenter>
                  <BlueCard>
            ...
            <div style={{ position: 'relative', zIndex: 2 }}>
              <div style={{ position: 'absolute', width: '100%', cursor: 'pointer', marginTop: '-14px' }}>
                <svg
                  style={{ height: '1.8rem', width: '1.8rem', margin: '0 auto' }}
                  fill="currentColor"
                  viewBox="0 0 20 20"
          ...
          <AutoColumn style={{ paddingBottom: '1rem', paddingTop: '1rem' }}>
            {addIsUnsupported ? (
