...
import usePending from '../../sushi-hooks/queries/usePending'
import useSushiBar from '../../sushi-hooks/actions/useSushiBar'
...
export default function CurrencyInputPanel({
  ...
  //const allowance = useAllowance(lpTokenAddress)
  const pendingSushi = usePending(pid)
      ...
      <InputPanel id={id}>
        <Container hideInput={hideInput}>
          ...
          <InputRow style={hideInput ? { padding: '0', borderRadius: '8px' } : {}} selected={disableCurrencySelect}>
            {!hideInput && (
              <>
                <NumericalInput className="token-amount-input" value={pendingSushi} onUserInput={() => null} />
              </>
            )}
            {/* {!allowance.toNumber ? (
              ...
              >
                <Aligner>
                  <StyledButtonName>Claim</StyledButtonName>
                </Aligner>
              </ButtonSelect>
            )} */}
          </InputRow>
